		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sybvensapui5gestiondeviajes2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sybvensapui5gestiondeviajes2-display": {
								"semanticObject": "sybvensapui5gestiondeviajes2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sybvensapui5.gestiondeviajes2",
									"url": sap.ui.require.toUrl("sybvensapui5/gestiondeviajes2")
								}
							}
						}
					}
