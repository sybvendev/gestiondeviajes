		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sybvensapui5gestiondeviajes1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sybvensapui5gestiondeviajes1-display": {
								"semanticObject": "sybvensapui5gestiondeviajes1",
								"action": "display",
								"description": "Gestion de Viajes",
								"title": "Gestion de Viajes",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sybvensapui5.gestiondeviajes1",
									"url": sap.ui.require.toUrl("sybvensapui5/gestiondeviajes1")
								}
							}
						}
					}
