		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sybvensapui6gestiondeviajes3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sybvensapui6gestiondeviajes3-display": {
								"semanticObject": "sybvensapui6gestiondeviajes3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sybvensapui6.gestiondeviajes3",
									"url": sap.ui.require.toUrl("sybvensapui6/gestiondeviajes3")
								}
							}
						}
					}
